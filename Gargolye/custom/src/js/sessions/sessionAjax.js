...
async function setESignaturesMessage() {
    ...
    async function sendCode(newCode) {
        ...
        try {
            ...
            const generatedCodeSuccessfully = await _UTIL.fetchData('generateAuthenticationCode', {
                tempUserId,
                latitude,
                longitude,
            });
    ...
    let redactedName =
        loginMessageData.getSignerLoginMessageDataResult.maskedFirstName +
        ' ' +
        loginMessageData.getSignerLoginMessageDataResult.maskedLastName;
    ...
    popupMessageText.textContent = `The document shared with you contains information about ${redactedName}. To confirm your identity
    ...
    function updateHTMLAfterCodeSent() {
        ...
        messageDiv.innerHTML = `<p id='eSignLoginMessage'>
...
function getDefaultAnywhereSettings() {
    ...
    $.ajax({
        ...
        success: function (response, status, xhr) {
            ...
            $.session.defaultFormsLocation = res.defaultFormslocation;
            $.session.defaultFormsLocationName = res.defaultFormslocationname;
            $.session.defaultFormsGroupValue = res.defaultFormsgroup;
            $.session.defaultFormsGroupName = res.defaultFormsgroupname;
            $.session.defaultEmploymentLocation = res.defaultEmploymentlocation;
            $.session.defaultEmploymentLocationName = res.defaultEmploymentlocationname;
            $.session.defaultEmploymentGroupValue = res.defaultEmploymentgroup;
            $.session.defaultEmploymentGroupName = res.defaultEmploymentgroupname;
