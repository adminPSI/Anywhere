      ...
      if (resXML) {
        ...
        if (windowName && windowName.innerHTML === 'Failed attempts') {
          ...
          document.body.appendChild(loginWarningPopup);
            ...
            $('#error').css('display', 'block');
            $('#errortext').text('Invalid username/password combination');
          } else if (res.indexOf('Invalid password') != -1) {//never will be hit, needs removed
              $('#error').css('opacity', '1');
              $('#error').css('display', 'block');
...
function strongPasswordValue() {
	$.ajax({
		type: 'POST',
		url: $.webServer.protocol + '://' + $.webServer.address + ':' + $.webServer.port + '/' + $.webServer.serviceName + '/getStrongPassword/',
		data: '{}',
		contentType: 'application/json; charset=utf-8',
		dataType: 'json',
		success: function (response, status, xhr) {
...
function getCustomLoginTextAndVersion(callback) {
	$.ajax({
		type: 'POST',
		url: $.webServer.protocol + '://' + $.webServer.address + ':' + $.webServer.port + '/' + $.webServer.serviceName + '/getCustomTextAndAnywhereVersion/',
		contentType: 'application/json; charset=utf-8',
		dataType: 'json',
		success: function (response, status, xhr) {
			var res = JSON.stringify(response);
...
function tokenCheck() {
	...
	$.ajax({
		type: 'POST',
		url: $.webServer.protocol + '://' + $.webServer.address + ':' + $.webServer.port + '/' + $.webServer.serviceName + '/tokenCheck/',
...
function postError(errNum, errMsg, errLvl) {
	...
	var dataString = 't=' + strDate + '&l=' + 'client' + '&u=' + $.session.Name + ' ' + $.session.LName + '&en=' + errNum + '&em=' + errMsg + '&s=' + errLvl;
	//$.ajax({
	//  type: "POST",
...
function saveDefaultLocationValueAjax(switchCase, locationId) {
	$.ajax({
		type: 'POST',
		url: $.webServer.protocol + '://' + $.webServer.address + ':' + $.webServer.port + '/' + $.webServer.serviceName + '/saveDefaultLocationValue/',
...
function updateVersionAjax() {
	$.ajax({
		type: 'POST',
		url: $.webServer.protocol + '://' + $.webServer.address + ':' + $.webServer.port + '/' + $.webServer.serviceName + '/updateVersion/',
...
function checkLogin() {
	$.ajax({
		...
		url: $.webServer.protocol + '://' + $.webServer.address + ':' + $.webServer.port + '/' + $.webServer.serviceName + '/ValidateLogin/',
...
function checkInfalConnectionAjax(callback) {
	$.ajax({
		type: 'POST',
		url: $.webServer.protocol + '://' + $.webServer.address + ':' + $.webServer.port + '/' + $.webServer.serviceName + '/CheckInfalConnection/',
		data: '{}',
		contentType: 'application/json; charset=utf-8',
		dataType: 'json',
		success: function (response, status, xhr) {
...
function getUserPermissions(callback) {
	$.ajax({
		type: 'POST',
		url: $.webServer.protocol + '://' + $.webServer.address + ':' + $.webServer.port + '/' + $.webServer.serviceName + '/getUserPermissions/',
		data: '{"token":"' + $.session.Token + '"}',
		contentType: 'application/json; charset=utf-8',
		dataType: 'json',
		success: function (response, status, xhr) {
...
function featureLogging(appName) {
	if (appName != 'roster') {
		...
		$.ajax({
			type: 'POST',
			url: $.webServer.protocol + '://' + $.webServer.address + ':' + $.webServer.port + '/' + $.webServer.serviceName + '/featureLogging/',
...
function getDefaultAnywhereSettings() {
	$.ajax({
		type: 'POST',
		url: $.webServer.protocol + '://' + $.webServer.address + ':' + $.webServer.port + '/' + $.webServer.serviceName + '/getDefaultAnywhereSettingsJSON/',
		data: '{"token":"' + $.session.Token + '"}',
		contentType: 'application/json; charset=utf-8',
		dataType: 'json',
		success: function (response, status, xhr) {
...
function authenticatedLogin(key) {
	...
	$.ajax({
		type: 'POST',
		url: $.webServer.protocol + '://' + $.webServer.address + ':' + $.webServer.port + '/' + $.webServer.serviceName + '/authenticatedLogin/',
		data: JSON.stringify(insertData),
		contentType: 'application/json; charset=utf-8',
		dataType: 'json',
		success: function (response, status, xhr) {
