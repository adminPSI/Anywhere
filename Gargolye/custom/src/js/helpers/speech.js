    ...
    try {
      ...
      switch (error.message) {
        case 'throwIfNullOrWhitespace:subscriptionKey':
          alert("Error initalizing Speech to Text. No API Key found, or API Key has been entered incorrectly. Please contact system administrator to add Azure Speech API Key.")
          break;
        default:
          alert("Error initalizing Speech to Text. Please contact system administrator to make sure you have a valid Speech to Text connection.")
          break;
      }
      console.error(error)
      return false
