const outcomes = (function () {
    ...
    async function planViewPOPUP() {
        ...
        message.innerText = "A new ISP is available for viewing for this individual. You are required to acknowledge that you've read this plan before documenting for services.Would you like to read the plan now or later ? ";
