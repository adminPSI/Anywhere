const adminSingleEntryWidget = (function () {
    ...
    function eventSetup() {
        ...
        applyFiltersBtn.addEventListener('click', event => {
            ...
            populateCountInfo();
            widgetSettingsAjax.setWidgetFilter('admindashsingleentrywidget', 'employee', selectedConsumerId)
            widgetSettingsAjax.setWidgetFilter('admindashsingleentrywidget', 'location', selectedLocationId)
        });
    ...
    async function groupCountInfo(data, selectedConsumerId, selectedLocationId) {
        entriesObj = {};
        data.forEach(d => {
    ...
    async function init() {     
        ...
        var filterLocationDefaultValue = await widgetSettingsAjax.getWidgetFilter('admindashsingleentrywidget', 'location');
        selectedLocationId = filterLocationDefaultValue.getWidgetFilterResult;
        var filterEmployeeDefaultValue = await widgetSettingsAjax.getWidgetFilter('admindashsingleentrywidget', 'employee');
        selectedConsumerId = filterEmployeeDefaultValue.getWidgetFilterResult;
