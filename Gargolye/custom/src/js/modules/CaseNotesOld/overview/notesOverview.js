var notesOverview = (function () {
  ...
  function initFilterDisplay() {
    ...
    if (!currentFilterDisplay) {
      ...
      btnWrapFilter = cnFilters.filterButtonSet(
        billerName,
        displayConsumerName,
        'All',
        'All',
        'All',
        dispalyServiceDateStart,
        dispalyServiceDateEnd,
        displayDateEnteredStart,
        dispalyDatesEnteredEnd,
        'All',
        'All',
        'All',
        'All',
      ...
      btnWrapFilter = cnFilters.ShowHideFilter(
        billerName,
        displayConsumerName,
        'All',
        'All',
  ...
  function buildTopBtns() {
    ...
    var cnReportBtn = generateReports.createMainReportButton([
      { text: 'Detail Report', filterValues },
      { text: 'Minutes By Date', filterValues },
      { text: 'Time Analysis Report', filterValues },
      { text: 'TXX Case Notes', filterValues },
    ]);
    ...
    const multiSelectBtns = buildMultiSelectButtons();
  ...
  function setupActionNav() {
    var passBtn = button.build({
      text: 'Pass',
      style: 'secondary',
      type: 'contained',
      attributes: [{ key: 'data-action-nav', value: 'pass' }],
    });
    var rejectBtn = button.build({
      text: 'Reject',
      style: 'secondary',
      type: 'outlined',
      attributes: [{ key: 'data-action-nav', value: 'reject' }],
    });

    ACTION_NAV.populate([passBtn, rejectBtn]);
    ACTION_NAV.hide();
  }
  ...
  function buildMultiSelectButtons() {
    const btnWrap = document.createElement('div');
