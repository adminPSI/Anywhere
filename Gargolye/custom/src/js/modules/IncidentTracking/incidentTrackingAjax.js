var incidentTrackingAjax = (function() {
	...
	function sendNotification(notificationType, employeeId) {
		...
		$.ajax({
			type: 'POST',
			url: $.webServer.protocol + '://' + $.webServer.address + ':' + $.webServer.port + '/' + $.webServer.serviceName + '/sendITNotification/',
			data: '{"token":"' + $.session.Token + '","notificationType":"' + notificationType + '","employeeId":"' + employeeId + '"}',
	...
	function getInvolvementTypeData(callback) {
		$.ajax({
			type: 'POST',
			url: $.webServer.protocol + '://' + $.webServer.address + ':' + $.webServer.port + '/' + $.webServer.serviceName + '/getITInvolvementTypeData/',
	...
	function getIncidentCategories(callback) {
		$.ajax({
			type: 'POST',
			url: $.webServer.protocol + '://' + $.webServer.address + ':' + $.webServer.port + '/' + $.webServer.serviceName + '/getITIncidentCategories/',
			data: '{"token":"' + $.session.Token + '"}',
			contentType: 'application/json; charset=utf-8',
			dataType: 'json',
			success: function(response, status, xhr) {
	...
	function getIncidentLocationDetail(callback) {
		$.ajax({
			type: 'POST',
			url: $.webServer.protocol + '://' + $.webServer.address + ':' + $.webServer.port + '/' + $.webServer.serviceName + '/getITIncidentLocationDetail/',
			data: '{"token":"' + $.session.Token + '"}',
			contentType: 'application/json; charset=utf-8',
			dataType: 'json',
			success: function(response, status, xhr) {
	...
	function getConsumerServiceLocations(consumerId, callback) {
		$.ajax({
			type: 'POST',
			url: $.webServer.protocol + '://' + $.webServer.address + ':' + $.webServer.port + '/' + $.webServer.serviceName + '/getITConsumerServiceLocations/',
	...
	function getITReviewTableData(retrieveData, callback) {
		...
		$.ajax({
			type: 'POST',
			url: $.webServer.protocol + '://' + $.webServer.address + ':' + $.webServer.port + '/' + $.webServer.serviceName + '/getITReviewTableData/',
	...
	function getEmployeesInvolvedEmployeeDropdown(callback) {
		$.ajax({
			type: 'POST',
			url:
				$.webServer.protocol + '://' + $.webServer.address + ':' + $.webServer.port + '/' + $.webServer.serviceName + '/getEmployeesInvolvedEmployeeDropdown/',
			data: '{"token":"' + $.session.Token + '"}',
			contentType: 'application/json; charset=utf-8',
			dataType: 'json',
			success: function(response, status, xhr) {
	...
	function getITReviewPageEmployeeListAndSubList(supervisorId, callback) {
		$.ajax({
			type: 'POST',
			url:
				$.webServer.protocol + '://' + $.webServer.address + ':' + $.webServer.port + '/' + $.webServer.serviceName + '/getITReviewPageEmployeeListAndSubList/',
	...
	function getIncidentEditReviewDataAllObjects(incidentId, callback) {
		$.ajax({
			type: 'POST',
			url:
				$.webServer.protocol + '://' + $.webServer.address + ':' + $.webServer.port + '/' + $.webServer.serviceName + '/getIncidentEditReviewDataAllObjects/',
	...
	function deleteITIncident(incidentId) {
		...
		$.ajax({
			type: 'POST',
			url: $.webServer.protocol + '://' + $.webServer.address + ':' + $.webServer.port + '/' + $.webServer.serviceName + '/deleteAnywhereITIncident/',
			data: '{"token":"' + $.session.Token + '","incidentId":"' + incidentId + '"}',
			contentType: 'application/json; charset=utf-8',
			dataType: 'json',
			success: function(response, status, xhr) {
	...
	function saveUpdateITIncident(incidentData, callback) {
		...
		$.ajax({
			type: 'POST',
			url: $.webServer.protocol + '://' + $.webServer.address + ':' + $.webServer.port + '/' + $.webServer.serviceName + '/saveUpdateITIncident/',
	...
	function getReviewedByDropdown(callback) {
		...
		$.ajax({
			type: 'POST',
			url: $.webServer.protocol + '://' + $.webServer.address + ':' + $.webServer.port + '/' + $.webServer.serviceName + '/getReviewedByDropdown/',
			data: '{"token":"' + $.session.Token + '"}',
			contentType: 'application/json; charset=utf-8',
			dataType: 'json',
			success: function(response, status, xhr) {
	...
	function getInjuryLocationsDropdown(callback) {
		...
		$.ajax({
			type: 'POST',
			url: $.webServer.protocol + '://' + $.webServer.address + ':' + $.webServer.port + '/' + $.webServer.serviceName + '/getInjuryLocationsDropdown/',
			data: '{"token":"' + $.session.Token + '"}',
			contentType: 'application/json; charset=utf-8',
			dataType: 'json',
			success: function(response, status, xhr) {
	...
	function getInjuryTypesDropdown(callback) {
		...
		$.ajax({
			type: 'POST',
			url: $.webServer.protocol + '://' + $.webServer.address + ':' + $.webServer.port + '/' + $.webServer.serviceName + '/getInjuryTypesDropdown/',
			data: '{"token":"' + $.session.Token + '"}',
			contentType: 'application/json; charset=utf-8',
			dataType: 'json',
			success: function(response, status, xhr) {
	...
	function getitConsumerFollowUpTypes(callback) {
		$.ajax({
			type: 'POST',
			url: $.webServer.protocol + '://' + $.webServer.address + ':' + $.webServer.port + '/' + $.webServer.serviceName + '/getitConsumerFollowUpTypes/',
			data: '{"token":"' + $.session.Token + '"}',
			contentType: 'application/json; charset=utf-8',
			dataType: 'json',
			success: function(response, status, xhr) {
	...
	function getitReportingCategories(callback) {
		$.ajax({
			type: 'POST',
			url: $.webServer.protocol + '://' + $.webServer.address + ':' + $.webServer.port + '/' + $.webServer.serviceName + '/getitReportingCategories/',
			data: '{"token":"' + $.session.Token + '"}',
			contentType: 'application/json; charset=utf-8',
			dataType: 'json',
			success: function(response, status, xhr) {
	...
	function getInterventionTypesDropdown(callback) {
		$.ajax({
			type: 'POST',
			url: $.webServer.protocol + '://' + $.webServer.address + ':' + $.webServer.port + '/' + $.webServer.serviceName + '/getInterventionTypesDropdown/',
			data: '{"token":"' + $.session.Token + '"}',
			contentType: 'application/json; charset=utf-8',
			dataType: 'json',
			success: function(response, status, xhr) {
	...
	function getitConsumerInterventions(consumerId, incidentId, callback) {
		$.ajax({
			type: 'POST',
			url: $.webServer.protocol + '://' + $.webServer.address + ':' + $.webServer.port + '/' + $.webServer.serviceName + '/getitConsumerInterventions/',
			data: '{"token":"' + $.session.Token + '","consumerId":"' + consumerId + '","incidentId":"' + incidentId + '"}',
			contentType: 'application/json; charset=utf-8',
			dataType: 'json',
			success: function(response, status, xhr) {
	...
	function getitConsumerInjuries(consumerId, incidentId, callback) {
		$.ajax({
			type: 'POST',
			url: $.webServer.protocol + '://' + $.webServer.address + ':' + $.webServer.port + '/' + $.webServer.serviceName + '/getitConsumerInjuries/',
			data: '{"token":"' + $.session.Token + '","consumerId":"' + consumerId + '","incidentId":"' + incidentId + '"}',
			contentType: 'application/json; charset=utf-8',
			dataType: 'json',
			success: function(response, status, xhr) {
	...
	function getitConsumerReviews(consumerId, incidentId, callback) {
		$.ajax({
			type: 'POST',
			url: $.webServer.protocol + '://' + $.webServer.address + ':' + $.webServer.port + '/' + $.webServer.serviceName + '/getitConsumerReviews/',
			data: '{"token":"' + $.session.Token + '","consumerId":"' + consumerId + '","incidentId":"' + incidentId + '"}',
			contentType: 'application/json; charset=utf-8',
			dataType: 'json',
			success: function(response, status, xhr) {
	...
	function getitConsumerFollowUps(consumerId, incidentId, callback) {
		$.ajax({
			type: 'POST',
			url: $.webServer.protocol + '://' + $.webServer.address + ':' + $.webServer.port + '/' + $.webServer.serviceName + '/getitConsumerFollowUps/',
			data: '{"token":"' + $.session.Token + '","consumerId":"' + consumerId + '","incidentId":"' + incidentId + '"}',
			contentType: 'application/json; charset=utf-8',
			dataType: 'json',
			success: function(response, status, xhr) {
	...
	function getitConsumerReporting(consumerId, incidentId, callback) {
		$.ajax({
			type: 'POST',
			url: $.webServer.protocol + '://' + $.webServer.address + ':' + $.webServer.port + '/' + $.webServer.serviceName + '/getitConsumerReporting/',
			data: '{"token":"' + $.session.Token + '","consumerId":"' + consumerId + '","incidentId":"' + incidentId + '"}',
			contentType: 'application/json; charset=utf-8',
			dataType: 'json',
			success: function(response, status, xhr) {
	...
	function itDeleteConsumerFollowUp(itConsumerFollowUpId, callback) {
		$.ajax({
			type: 'POST',
			url: $.webServer.protocol + '://' + $.webServer.address + ':' + $.webServer.port + '/' + $.webServer.serviceName + '/itDeleteConsumerFollowUp/',
			data: '{"token":"' + $.session.Token + '","itConsumerFollowUpId":"' + itConsumerFollowUpId + '"}',
			contentType: 'application/json; charset=utf-8',
			dataType: 'json',
			success: function(response, status, xhr) {
	...
	function saveUpdateITConsumerFollowUp(data, callback) {
		...
		$.ajax({
			type: 'POST',
			url: $.webServer.protocol + '://' + $.webServer.address + ':' + $.webServer.port + '/' + $.webServer.serviceName + '/saveUpdateITConsumerFollowUp/',
	...
	function saveUpdateITConsumerInjuries(data, callback) {
		...
		$.ajax({
			type: 'POST',
			url: $.webServer.protocol + '://' + $.webServer.address + ':' + $.webServer.port + '/' + $.webServer.serviceName + '/saveUpdateITConsumerInjuries/',
			data: JSON.stringify(data),
			contentType: 'application/json; charset=utf-8',
			dataType: 'json',
			success: function(response, status, xhr) {
	...
	function itDeleteConsumerInjuries(itConsumerInjuryId, callback) {
		$.ajax({
			type: 'POST',
			url: $.webServer.protocol + '://' + $.webServer.address + ':' + $.webServer.port + '/' + $.webServer.serviceName + '/itDeleteConsumerInjuries/',
	...
	function itDeleteConsumerInterventions(itConsumerInterventionId, callback) {
		$.ajax({
			type: 'POST',
			url: $.webServer.protocol + '://' + $.webServer.address + ':' + $.webServer.port + '/' + $.webServer.serviceName + '/itDeleteConsumerInterventions/',
			data: '{"token":"' + $.session.Token + '","itConsumerInterventionId":"' + itConsumerInterventionId + '"}',
			contentType: 'application/json; charset=utf-8',
			dataType: 'json',
			success: function(response, status, xhr) {
	...
	function saveUpdateITConsumerInterventions(data, callback) {
		...
		$.ajax({
			type: 'POST',
			url: $.webServer.protocol + '://' + $.webServer.address + ':' + $.webServer.port + '/' + $.webServer.serviceName + '/saveUpdateITConsumerInterventions/',
			data: JSON.stringify(data),
			contentType: 'application/json; charset=utf-8',
			dataType: 'json',
			success: function(response, status, xhr) {
	...
	function itDeleteConsumerReporting(itConsumerReportingId, callback) {
		$.ajax({
			type: 'POST',
			url: $.webServer.protocol + '://' + $.webServer.address + ':' + $.webServer.port + '/' + $.webServer.serviceName + '/itDeleteConsumerReporting/',
			data: '{"token":"' + $.session.Token + '","itConsumerReportingId":"' + itConsumerReportingId + '"}',
			contentType: 'application/json; charset=utf-8',
			dataType: 'json',
			success: function(response, status, xhr) {
	...
	function saveUpdateITConsumerReporting(data, callback) {
		...
		$.ajax({
			type: 'POST',
			url: $.webServer.protocol + '://' + $.webServer.address + ':' + $.webServer.port + '/' + $.webServer.serviceName + '/saveUpdateITConsumerReporting/',
			data: JSON.stringify(data),
			contentType: 'application/json; charset=utf-8',
			dataType: 'json',
			success: function(response, status, xhr) {
	...
	function itDeleteConsumerReviews(itConsumerReviewId, callback) {
		$.ajax({
			type: 'POST',
			url: $.webServer.protocol + '://' + $.webServer.address + ':' + $.webServer.port + '/' + $.webServer.serviceName + '/itDeleteConsumerReviews/',
	...
	function saveUpdateITConsumerReviews(data, callback) {
		...
		$.ajax({
			type: 'POST',
			url: $.webServer.protocol + '://' + $.webServer.address + ':' + $.webServer.port + '/' + $.webServer.serviceName + '/saveUpdateITConsumerReviews/',
			data: JSON.stringify(data),
			contentType: 'application/json; charset=utf-8',
			dataType: 'json',
			success: function(response, status, xhr) {
