var incidentOverview = (function() {
	...
	function populateSelectedFilterValues() {
		...
		if (filterData.alphaName === null) filterData.alphaName = $.session.LName + ', ' + $.session.Name;
	...
	function populateFilterDropdowns() {
		...
		incidentTrackingAjax.getITReviewPageEmployeeListAndSubList($.session.PeopleId, populateUserAndEmployeeDropdowns);
	}
	...
	function populateUserAndEmployeeDropdowns(res) {
		function decipherXML(res) {
			var xmlDoc,
				allEmployees = [];
			xmlDoc = UTIL.parseXml('<?xml version="1.0" encoding="UTF-8"?>' + res.getITReviewPageEmployeeListAndSubListResult);
