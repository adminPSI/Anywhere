const authorizationsAjax = (function () {
    ...
    async function getAssessmentEntriesByIDAsync(registerId, lastUpdate) {
        try {
            const result = await $.ajax({
                type: 'POST',
                url:
    ...
    async function insertUpdateAssessmentInfo(retrieveData) {
        try {
            const data = await $.ajax({
                type: 'POST',
                url:
    ...
    async function getFundingRangeAsync(
        consumerId,
        methodology,
        score,
        startDate
    ...
    return {
        ...
        getAssessmentEntriesByIDAsync,
        insertUpdateAssessmentInfo,
        getFundingRangeAsync
    };
})();
