class EditWorkflowStepComponent {
  ...
  createPopup() {
    ...
    dueDateInput.addEventListener('change', e => {
      if (e.target.value === '') {
        ...
        this.cache['stepDueDate'] = {
          original: dueDate,
          modified: this.step.dueDate,
          isChanged: changed,
          eventTypeId: this.step.stepId,
          eventType: 'step',
          eventId: wfeventid,
        };
      }
    ...
    startDateInput.addEventListener('change', e => {
      if (e.target.value === '') {
        ...
        this.cache['stepStartDate'] = {
          original: startDate,
          modified: this.step.startDate,
          isChanged: changed,
          eventTypeId: this.step.stepId,
          eventType: 'step',
          eventId: wfeventid,
    ...
    doneDateInput.addEventListener('change', e => {
      if (e.target.value === '') {
        ...
        this.cache['stepDoneDate'] = {
          original: doneDate,
          modified: this.step.doneDate,
          isChanged: changed,
          eventTypeId: this.step.stepId,
          eventType: 'step',
          eventId: wfeventid,
    ...
    responsibleDropdown.addEventListener('change', e => {
      ...
      this.cache['stepResponsiblePartyId'] = {
        original: responsiblePartyId,
        modified: this.step.responsiblePartyId,
        isChanged: changed,
        eventTypeId: this.step.stepId,
        eventType: 'step',
        eventId: wfeventid,
    ...
    commentsTextInput.addEventListener('change', e => {
      ...
      this.cache['stepComments'] = {
        original: comments,
        modified: this.step.comments,
        isChanged: changed,
        eventTypeId: this.step.stepId,
        eventType: 'step',
        eventId: 11,
  ...
  async poplateResponsibleDropDownbyTypeID(typeID) {
    ...
    const { getPeopleNamesResult: people } = await WorkflowViewerAjax.getPeopleNamesAsync(peopleId, typeID);
