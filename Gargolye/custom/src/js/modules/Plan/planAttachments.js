const planAttachment = (() => {
  ...
  class PlanAttachment {
    ...
    buildAttachmentButton () {
      ...
      if (attachments.has(this.questionId)) this.attachmentsForQuestion = attachments.get(this.questionId);
    ...
    attachmentPopup() {
      ...
      function addNewAttachment() {
        ...
        newFileContainer.getElementsByTagName("input")[0].addEventListener('change', evt => fileValidation(evt.target))
