const roster2 = (function () {
    ...
    function filterButtonSet() {
        ...
        filteredDateBtn = button.build({
            ...
            callback: () => { buildFilterPopup('filteredDateBtn') },
        });
        ...
        selectedLocationNameBtn = button.build({
            ...
            type: 'text',
            classNames: 'filterSelectionBtn',
            callback: () => { buildFilterPopup('selectedLocationNameBtn') },
        });
        selectedLocationNameCloseBtn = button.build({
            ...
            callback: () => { closeFilter('selectedLocationNameBtn') },
        });
        ...
        selectedGroupNameBtn = button.build({
            ...
            type: 'text',
            classNames: 'filterSelectionBtn',
            callback: () => { buildFilterPopup('selectedGroupNameBtn') },
        });
    ...
    function buildFilterPopup(IsShow) {
        ...
        // build popup
        if (!hideDateFilter) {
            if (IsShow == 'ALL' || IsShow == 'filteredDateBtn')
                FILTER_POPUP.appendChild(DATE_INPUT);
        }
        if (IsShow == 'ALL' || IsShow == 'selectedLocationNameBtn')
            FILTER_POPUP.appendChild(LOCATION_DROPDOWN);
        if (IsShow == 'ALL' || IsShow == 'selectedGroupNameBtn')
            FILTER_POPUP.appendChild(GROUP_DROPDOWN);
