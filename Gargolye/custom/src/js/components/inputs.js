const input = (function () {
    function build(opts) {
        ...
        if (type === 'password') {
            eyeBtn = button.build({
                ...
                style: 'outlined', 
                type: 'text',
                classNames: 'eyeInputIcon',
                icon: 'passwordShow',
                attributes: [{ key: 'data-visible-password', value: 'false' }],
                callback: () => {
                    event.preventDefault(); togglePasswordVisibility(input.id)
                },
            });
        }
    ...
    `;
        ...
        if (type === 'password') wrap.appendChild(eyeBtn);
        return wrap;
    }
    ...
    function togglePasswordVisibility(id) {
        ...
        passwordToggleBtn = document.getElementById('toggle' + id);
