...
namespace Anywhere.service.Data
{
    public class IncidentTrackingWorker
    {
        ...
        public IncidentTrackingReviewTableData[] GetITReviewTableData(string token, string locationId, string groupId, string consumerId, string employeeId, string supervisorId, string subcategoryId, string fromDate, string toDate, string viewCaseLoad)
        {
            string itReviewTableDataString = dg.getITReviewTableData(token, locationId, groupId, consumerId, employeeId, supervisorId, subcategoryId, fromDate, toDate, viewCaseLoad);
